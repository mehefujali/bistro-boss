import { FaCalendar, FaCalendarCheck, FaHome, FaWallet } from "react-icons/fa";
    ...
    <div className=" grid grid-cols-12 h-screen">
      <div className=" h-full col-span-2 p-7 bg-[#D1A054] navlinks-dashboard">
        <ul className=" flex flex-col gap-4">
          ...
          <li>
            <NavLink to="/review" className=" flex gap-1 text-lg  items-center">
              {" "}
              <FaCalendar />
              Reservation{" "}
            </NavLink>
          ...
          <li>
            <NavLink to="/payment-history" className=" flex gap-1 text-lg  items-center">
              {" "}
              <FaWallet />
              Payment history{" "}
            </NavLink>
        ...
        <ul className=" flex flex-col gap-4">
          ...
          <li>
            <Link to="/ourshop/salad" className=" flex gap-1 text-lg  items-center">
              {" "}
              <RiShoppingBag2Fill />
               Shop{" "}
            </Link>
